...
export HAWOR_KEEP_INTERMEDIATE=false
...
- Environment variables use the same semantics as the CLI flags: `HAWOR_KEEP_INTERMEDIATE` and `HAWOR_CLEANUP_FAILED_CACHE`.
